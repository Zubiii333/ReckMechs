<?php
echo "Testing get_mechanics API...\n";

// Test the API directly
$_GET['date'] = '2025-09-12'; // Friday, September 12, 2025 from the screenshot
...
if ($data) {
    ...
    if (isset($data['mechanics'])) {
        ...
        foreach ($data['mechanics'] as $mechanic) {
            echo "- {$mechanic['name']}: {$mechanic['slots_available']}/4 available\n";
        }
    }
} else {
